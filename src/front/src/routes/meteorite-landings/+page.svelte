...
<button onclick={() => goto('../integrations/meteorite-landings/nyc-trees')}>Grafica API externa 2</button>
<button onclick={() => goto('../integrations/meteorite-landings/social-drinking-behaviors')}>Grafica API SOS 3</button>
